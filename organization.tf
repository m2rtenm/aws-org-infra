...
resource "aws_organizations_account" "dev" {
  ...
  role_name = "dev-OrganizationAccountAccessRole"
}
...
resource "aws_organizations_account" "prod" {
  ...
  role_name = "prod-OrganizationAccountAccessRole"
}
...
resource "aws_organizations_account" "shared" {
  ...
  role_name = "shared-OrganizationAccountAccessRole"
}
...
resource "aws_organizations_account" "sec" {
  ...
  parent_id = aws_organizations_organizational_unit.other.id
  role_name = "sec-OrganizationAccountAccessRole"
}